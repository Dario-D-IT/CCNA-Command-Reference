...
## Svrha
OSPF (Open Shortest Path First) je **Link-State** routing protokol koji koristi **Dijkstrin SPF algoritam** za izračun najbolje putanje. Otvoreni standard — radi na svim proizvođačima.
